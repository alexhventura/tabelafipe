...
export interface VehiclePageBundle {
  ...
  platform: { platformId: string | null; platformNome: string | null; entity: Record<string, unknown> | null } | null;
  transmission: { transmissionId: string | null; transmissionNome: string | null } | null;
